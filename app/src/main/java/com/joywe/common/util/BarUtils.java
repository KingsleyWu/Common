...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (Utils.getApplication().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, Utils.getApplication().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = Utils.getApplication().getSystemService("statusbar");
